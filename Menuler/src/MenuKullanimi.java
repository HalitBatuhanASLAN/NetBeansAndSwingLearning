...
public class MenuKullanimi extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuKullanimi.class.getName());
    ...
    private void initComponents() {
        ...
        yazi.setColumns(20);
        yazi.setRows(5);
        jScrollPane1.setViewportView(yazi);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(i == JFileChooser.APPROVE_OPTION)
        {
            ...
            try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(file)))){
                ...
                System.getLogger(MenuKullanimi.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuKullanimi().setVisible(true));
    }
