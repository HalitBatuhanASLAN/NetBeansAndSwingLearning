...
public class Oyun extends JPanel implements KeyListener, ActionListener{
    ...
    public Oyun() {
        ...
        try {
            image = ImageIO.read(getClass().getResourceAsStream("uzaygemisi.png"));
        } catch (IOException ex) {
            System.getLogger(Oyun.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        {
            atesler.add(new Ates(uzayGemisiX + 10, 480));// + 15 ile image tam ortasından çıkarmayı sağladık
